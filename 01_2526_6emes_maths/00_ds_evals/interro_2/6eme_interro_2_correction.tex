...
B &= 5 \times \big((4 + 5) \times 2\big)\\
  &= 5 \times (9 \times 2) && \text{on calcule la parenthèse la plus intérieure} 4+5\\
  &= 5 \times 18\\
  &= 90
\end{align*}
...
D &= 3 \times \big[10 - (2 + 3)\big] + 5\\
  &= 3 \times [10 - 5] + 5 && \text{on calcule la parenthèse la plus intérieure} 2+3 \\
  &= 3 \times 5 + 5 && \text{il reste le calcul de 10 - 5 à faire dans la parenthèse} \\
  &= 15 + 5 && \text{car la multiplication est prioritaire sur l'addition. Il faut calculer } 3 \times 5 \text{ et non } 5 + 5 \\
  &= 20
\end{align*}
\end{parts}
...
\textcolor{red}{Il est conseillé de mettre des parenthèses au moment du regroupement, même si elles n'ont pas d'impact sur le résultat. Elles permettent de bien comprendre quel groupement astucieux a été fait.}
...
\begin{center}
\includegraphics[width=0.5\linewidth]{soustraction.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\linewidth]{multiplication.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\linewidth]{addition.jpg}
\end{center}
...
\]
Il faut décider et \textcolor{red}{indiquer} à quoi on arrondit chaque terme. \\

Cela implique un choix : \textbf{\textcolor{red}{Approximer à un nombre qui (1) facilite le calcul (il ne faut pas qu'il soit trop compliqué à faire ensuite), mais qui (2) ne fait pas perdre trop de précision non plus.}} \\

Ici, on a décidé d'arrondir 
\begin{compactitem}
  \item \(78,4\) à la dizaine la plus proche : \(80\)
...
Ici, on a décidé d'arrondir 
\begin{compactitem}
  \item $2,98$ à l'unité la plus proche : $3$
  \item $5,1$ à l'unité la plus proche : $5$
\end{compactitem}
...
Ici, on a décidé d'arrondir 
\begin{compactitem}
  \item \(1204,32\) à la centaine la plus proche : \(1200\)
  \item \(98,8\) à la centaine la plus proche : \(100\)
\end{compactitem}
Attention, une erreur serait de dire que l'on arrondit tout au millier le plus proche. Ce qui aurait donné : 
\begin{compactitem}
  \item \(1204,32\) au millier le plus proche : \(1000\)
  \item \(98,8\) au millier le plus proche : \(0\)
L’ordre de grandeur de \(L\) aurait été $0$ car $1000 \times 0 = 0$. Donc il faut faire attention au choix d'arrondi pour qu'il ne nous fasse pas arriver à une approximation absurde.
\end{compactitem}
\end{parts}
\end{solution}
