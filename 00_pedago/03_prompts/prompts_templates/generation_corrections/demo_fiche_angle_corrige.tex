...
On sait que :
\begin{compactitem}
\item $\widehat{ABC}=37^\circ$ et $\widehat{CBD}=31^\circ$ (angles indiqués au point $B$), donc $\widehat{ABD}=37^\circ+31^\circ=68^\circ$,
\item On sait aussi (d'parès l'énoncé) que $\widehat{DAB}=68^\circ$
\end{compactitem}

Or la somme des angles d'un triangle vaut $180^\circ$. Donc, dans le triangle $ABD$ :
\[
