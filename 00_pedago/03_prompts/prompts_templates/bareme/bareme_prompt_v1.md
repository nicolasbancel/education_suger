...
Les questions sont référencées sous la forme :
- Ex1Q2 : Exercice 1, Question 2
- Ex4Q1a : Exercice 4, Question 1.a

Utilise systématiquement les intitulés complets : Exercice 1, Question 1, a, b, etc.

# Exemple de ligne attendue

La première ligne du tableau pourra par exemple être :
- Exercice 1
- Question 1
- b
- 2
- -0.5 si la phrase n’est pas syntaxiquement correcte
